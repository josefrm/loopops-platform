...
This project do not use vite default port.
...
- When debugging in the browser first run the app with npm run dev, check the port where it's running and then open that link http://localhost:8080 or http://localhost:8081
