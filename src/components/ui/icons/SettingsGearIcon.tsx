...
export const SettingsGearIcon: React.FC<SettingsGearIconProps> = ({
  width = 25,
  height = 25,
  className = '',
  fill = 'currentColor',
  ...
  return (
    <>
      <svg
        ...
        viewBox="0 0 25 25"
        fill="none"
        className={`settings-gear-icon transition-colors duration-200 ${className}`}
        style={{
          height: `${height}px`,
          width: `${width}px`,
        }}
      >
        <g clipPath="url(#clip0_583_7485)">
          <path
            fill={fill}
