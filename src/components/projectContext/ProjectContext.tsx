    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{ width: '60%' }}
        >
          <div className="p-loop-6 pb-0 sticky top-0 z-20 bg-white/95 backdrop-blur-sm transition-all duration-200">
            <div className="flex items-center gap-loop-2 text-2xl mb-loop-10">
          ...
          <div
            ...
            className="sticky top-[96px] z-10 bg-white/95 backdrop-blur-sm px-loop-6 pb-loop-4"
          >
            {isLoadingStages ? (
          ...
          <div className="sticky top-[152px] z-10 bg-white/95 backdrop-blur-sm px-loop-6 pb-loop-4 transition-all duration-200">
            {isLoadingStages ? (
