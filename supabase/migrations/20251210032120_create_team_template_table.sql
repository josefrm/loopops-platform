...
CREATE INDEX IF NOT EXISTS idx_global_team_templates_name ON loopops.global_team_templates(name);
CREATE INDEX IF NOT EXISTS idx_global_team_templates_stage ON loopops.global_team_templates(stage_template_id);
